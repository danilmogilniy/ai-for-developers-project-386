...
export const parseIsoDateTimeToMs = (value) => {
...
export const toIsoString = (valueMs) => {
...
export const overlaps = (candidateStartMs, candidateEndMs, intervals) => {
    const found = intervals.find((entry) => candidateStartMs < entry.endMs && candidateEndMs > entry.startMs);
    return found ?? null;
};
...
export const addMinutes = (startMs, minutes) => startMs + minutes * 60_000;
